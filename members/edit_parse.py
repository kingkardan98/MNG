...
OPERATION_FORMAT = {
    '.availability': '.<br /> <p class="gap5"></p> Availability',
    '.spendable': '.<br /> <p class="gap5"></p> Spendable',
    '.email': '.<br /> <p class="gap5"></p> Email',
    '.author': '.<br /> <p class="gap5"></p> Author',
    '.name': '.<br /> <p class="gap5"></p> Name'
}
